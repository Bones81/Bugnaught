            ...
            <footer className="container-fluid mt-auto bg-secondary sticky-bottom">
                <div className="row align-items-center justify-content-between mx-5">
                    ...
                    <div className="col-9 col-lg-4 p-3">
                        <p className="text-end text-dark footer-script">Built with React, TypeScript, Bootstrap on the front end. Back end TBD but likely Flask running PostgreSQL data storage. Bugnaught is a hypothetical engineering team bug tracking application. It has been designed primarily as a showcase project for software engineer Nathan Freeman.</p>
                    </div>
                </div>
            </footer>
        </>
